  ...
  group('Oauth2DeviceAuthorization', () {
    test('model', () {
      ...
      final result = Oauth2DeviceAuthorization.fromMap(map);
            ...
            expect(result.device_code, '5f3c8d2a1b9e4f7a6c8b2d1e9f4a7b3c5d8e1f2a9b4c7d6e3f5a8b1c4d7e2f9a');
                  expect(result.user_code, 'ABCD-EFGH');
                  expect(result.verification_uri, 'https://cloud.appwrite.io/console/oauth2/device');
                  expect(result.verification_uri_complete, 'https://cloud.appwrite.io/console/oauth2/device?user_code=ABCD-EFGH');

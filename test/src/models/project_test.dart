    ...
    test('model', () {
      ...
      final result = Project.fromMap(map);
            ...
            expect(result.$id, '5e5ea5c16897e');
                  ...
                  expect(result.oAuth2ServerAuthorizationUrl, 'https://cloud.appwrite.io/oauth2/.well-known/openid-configuration');
                  ...
                  expect(result.oAuth2ServerDiscoveryUrl, 'https://auth.example.com/.well-known/openid-configuration');
          });
  });
}

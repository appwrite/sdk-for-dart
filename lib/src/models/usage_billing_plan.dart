...
class UsageBillingPlan implements Model {
    ...
    factory UsageBillingPlan.fromMap(Map<String, dynamic> map) {
        return UsageBillingPlan(
            ...
            member: map['member'] != null ? AdditionalResource.fromMap(map['member']) : null,
            realtime: AdditionalResource.fromMap(map['realtime']),
            realtimeMessages: AdditionalResource.fromMap(map['realtimeMessages']),
            realtimeBandwidth: map['realtimeBandwidth'] != null ? AdditionalResource.fromMap(map['realtimeBandwidth']) : null,
            ...
            credits: map['credits'] != null ? AdditionalResource.fromMap(map['credits']) : null,
        );
    }

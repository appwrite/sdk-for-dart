...
class BillingPlan implements Model {
    ...
    factory BillingPlan.fromMap(Map<String, dynamic> map) {
        return BillingPlan(
            ...
            limits: BillingPlanLimits.fromMap(map['limits']),
            group: enums.BillingPlanGroup.values.firstWhere((e) => e.value == map['group']),
            program: Program.fromMap(map['program']),
            dedicatedDatabases: BillingPlanDedicatedDatabaseLimits.fromMap(map['dedicatedDatabases']),
        );
    }

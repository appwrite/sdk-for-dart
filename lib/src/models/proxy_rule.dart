...
class ProxyRule implements Model {
    ...
    factory ProxyRule.fromMap(Map<String, dynamic> map) {
        return ProxyRule(
            ...
            deploymentResourceType: map['deploymentResourceType'] != null ? enums.ProxyRuleDeploymentResourceType.values.firstWhere((e) => e.value == map['deploymentResourceType']) : null,
            ...
            status: enums.ProxyRuleStatus.values.firstWhere((e) => e.value == map['status']),

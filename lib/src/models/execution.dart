...
class Execution<T> implements Model {
  ...
  factory Execution.fromMap(
    ...
    return Execution(
      ...
      requestHeaders: List<Headers<T>>.from(
        map['requestHeaders'].map((p) => Headers.fromMap(p, fromJson)),
      ),
      responseStatusCode: map['responseStatusCode'],
      responseBody: map['responseBody'].toString(),
      responseHeaders: List<Headers<T>>.from(
        map['responseHeaders'].map((p) => Headers.fromMap(p, fromJson)),
      ),

...
'accept': 'application/json',
  ...
  /// can use the search parameter to filter your results.
    ...
    Future<models.CollectionList> listCollections({required String databaseId, List<String>? queries, String? search, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// API or directly from your database console.
    ...
    Future<models.Collection> createCollection({required String databaseId, required String collectionId, required String name, List<String>? permissions, bool? documentSecurity, bool? enabled, List<Map>? attributes, List<Map>? indexes}) async {
        final String apiPath = '/databases/{databaseId}/collections'.replaceAll('{databaseId}', databaseId);
...
'accept': 'application/json',
  ...
  /// Update a collection by its unique ID.
    ...
    Future<models.Collection> updateCollection({required String databaseId, required String collectionId, String? name, List<String>? permissions, bool? documentSecurity, bool? enabled, bool? purge}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// List attributes in the collection.
    ...
    Future<models.AttributeList> listAttributes({required String databaseId, required String collectionId, List<String>? queries, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// 
    ...
    Future<models.AttributeBigint> createBigIntAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, int? min, int? max, int? xdefault, bool? array}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/bigint'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeBigint> updateBigIntAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required int? xdefault, int? min, int? max, String? newKey}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/bigint/{key}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{key}', key);
...
'accept': 'application/json',
  ...
  /// already existing documents.
    ...
    Future<models.AttributeBoolean> updateBooleanAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required bool? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// already existing documents.
    ...
    Future<models.AttributeDatetime> updateDatetimeAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeEmail> updateEmailAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeEnum> updateEnumAttribute({required String databaseId, required String collectionId, required String key, required List<String> elements, required bool xrequired, required String? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeFloat> updateFloatAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required double? xdefault, double? min, double? max, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeInteger> updateIntegerAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required int? xdefault, int? min, int? max, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeIp> updateIpAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// Create a geometric line attribute.
    ...
    Future<models.AttributeLine> createLineAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, List<List>? xdefault}) async {
...
'accept': 'application/json',
  ...
  /// already existing documents.
    ...
    Future<models.AttributeLine> updateLineAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, List<List>? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeLongtext> createLongtextAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, String? xdefault, bool? array, bool? encrypt}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/longtext'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeLongtext> updateLongtextAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, String? newKey}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/longtext/{key}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{key}', key);
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeMediumtext> createMediumtextAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, String? xdefault, bool? array, bool? encrypt}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/mediumtext'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeMediumtext> updateMediumtextAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, String? newKey}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/mediumtext/{key}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{key}', key);
...
'accept': 'application/json',
  ...
  /// Create a geometric point attribute.
    ...
    Future<models.AttributePoint> createPointAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, List<double>? xdefault}) async {
...
'accept': 'application/json',
  ...
  /// already existing documents.
    ...
    Future<models.AttributePoint> updatePointAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, List<double>? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// Create a geometric polygon attribute.
    ...
    Future<models.AttributePolygon> createPolygonAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, List<List>? xdefault}) async {
...
'accept': 'application/json',
  ...
  /// already existing documents.
    ...
    Future<models.AttributePolygon> updatePolygonAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, List<List>? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeRelationship> updateRelationshipAttribute({required String databaseId, required String collectionId, required String key, enums.RelationMutate? onDelete, String? newKey}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/relationship/{key}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{key}', key);
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeString> updateStringAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, int? size, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeText> createTextAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, String? xdefault, bool? array, bool? encrypt}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/text'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeText> updateTextAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, String? newKey}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/text/{key}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{key}', key);
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeUrl> updateUrlAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, String? newKey}) async {
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeVarchar> createVarcharAttribute({required String databaseId, required String collectionId, required String key, required int size, required bool xrequired, String? xdefault, bool? array, bool? encrypt}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/varchar'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// 
    ...
    Future<models.AttributeVarchar> updateVarcharAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required String? xdefault, int? size, String? newKey}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/attributes/varchar/{key}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{key}', key);
...
'accept': 'application/json',
  ...
  /// Get attribute by ID.
    ...
    Future<models.Model> getAttribute({required String databaseId, required String collectionId, required String key}) async {
...
'accept': 'application/json',
  ...
  /// API or directly from your database console.
    ...
    Future<models.DocumentList> createDocuments({required String databaseId, required String collectionId, required List<Map> documents, String? transactionId}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/documents'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// updated.
    ...
    Future<models.DocumentList> updateDocuments({required String databaseId, required String collectionId, Map? data, List<String>? queries, String? transactionId}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/documents'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// documents are deleted.
    ...
    Future<models.DocumentList> deleteDocuments({required String databaseId, required String collectionId, List<String>? queries, String? transactionId}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/documents'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
'accept': 'application/json',
  ...
  /// List indexes in the collection.
    ...
    Future<models.IndexList> listIndexes({required String databaseId, required String collectionId, List<String>? queries, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// Attributes can be `key`, `fulltext`, and `unique`.
    ...
    Future<models.Index> createIndex({required String databaseId, required String collectionId, required String key, required enums.DatabasesIndexType type, required List<String> attributes, List<enums.OrderBy>? orders, List<int>? lengths}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/indexes'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);

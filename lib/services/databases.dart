...
if (total != null) 'total': total,
  ...
  /// Attributes can be `key`, `fulltext`, and `unique`.
    ...
    Future<models.Index> createIndex({required String databaseId, required String collectionId, required String key, required enums.IndexType type, required List<String> attributes, List<enums.OrderBy>? orders, List<int>? lengths}) async {
        final String apiPath = '/databases/{databaseId}/collections/{collectionId}/indexes'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);

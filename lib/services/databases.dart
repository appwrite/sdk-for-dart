...
'array': array,
    ...
    /// already existing documents.
    /// 
    Future<models.AttributeFloat> updateFloatAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required double min, required double max, required double? xdefault, String? newKey}) async {
...
'array': array,
    ...
    /// already existing documents.
    /// 
    Future<models.AttributeInteger> updateIntegerAttribute({required String databaseId, required String collectionId, required String key, required bool xrequired, required int min, required int max, required int? xdefault, String? newKey}) async {

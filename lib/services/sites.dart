...
'accept': 'application/json',
  ...
  /// browser to start downloading the file to user downloads directory.
    Future<Uint8List> getDeploymentDownload({required String siteId, required String deploymentId, enums.DeploymentDownloadType? type, String? token}) async {
...
'accept': 'application/json',
  ...
  /// Get a list of all variables of a specific site.
    Future<models.VariableList> listVariables({required String siteId, List<String>? queries, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// and runtime (server-side rendering) as environment variables.
    Future<models.Variable> createVariable({required String siteId, required String variableId, required String key, required String value, bool? secret}) async {
        final String apiPath = '/sites/{siteId}/variables'.replaceAll('{siteId}', siteId);
...
'accept': 'application/json',
  ...
  /// Update variable by its unique ID.
    Future<models.Variable> updateVariable({required String siteId, required String variableId, String? key, String? value, bool? secret}) async {
        final String apiPath = '/sites/{siteId}/variables/{variableId}'.replaceAll('{siteId}', siteId).replaceAll('{variableId}', variableId);

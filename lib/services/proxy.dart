...
class Proxy extends Service {
  ...
  /// path, or all cached content for the domain.
    Future<models.ProxyInvalidation> createInvalidation({required String domain, required enums.InvalidationType type, String? reference}) async {
...
'accept': 'application/json',
  ...
  /// your results.
    Future<models.ProxyRuleList> listRules({List<String>? queries, bool? total}) async {
...
'accept': 'application/json',
  ...
  /// Rule ID is automatically generated as MD5 hash of a rule domain for
  /// performance purposes.
    Future<models.ProxyRule> createFunctionRule({required String domain, required String functionId, String? branch}) async {
...
'accept': 'application/json',
  ...
  /// Rule ID is automatically generated as MD5 hash of a rule domain for
  /// performance purposes.
    Future<models.ProxyRule> createRedirectRule({required String domain, required String url, required enums.StatusCode statusCode, required String resourceId, required enums.ProxyResourceType resourceType}) async {
...
'accept': 'application/json',
  ...
  /// Rule ID is automatically generated as MD5 hash of a rule domain for
  /// performance purposes.
    Future<models.ProxyRule> createSiteRule({required String domain, required String siteId, String? branch}) async {
...
'accept': 'application/json',
  ...
  /// Get a proxy rule by its unique ID.
    Future<models.ProxyRule> getRule({required String ruleId}) async {
        final String apiPath = '/proxy/rules/{ruleId}'.replaceAll('{ruleId}', ruleId);
  ...
  /// provisioned for the domain asynchronously in the background.
    Future<models.ProxyRule> updateRuleStatus({required String ruleId}) async {
        final String apiPath = '/proxy/rules/{ruleId}/status'.replaceAll('{ruleId}', ruleId);

...
if (rollback != null) 'rollback': rollback,
  ...
  /// object with the database metadata.
    Future<models.Database> get({required String databaseId}) async {
        final String apiPath = '/documentsdb/{databaseId}'.replaceAll('{databaseId}', databaseId);
...
if (enabled != null) 'enabled': enabled,
  ...
  /// can use the search parameter to filter your results.
    Future<models.CollectionList> listCollections({required String databaseId, List<String>? queries, String? search, bool? total}) async {
        final String apiPath = '/documentsdb/{databaseId}/collections'.replaceAll('{databaseId}', databaseId);
...
if (indexes != null) 'indexes': indexes,
  ...
  /// object with the collection metadata.
    Future<models.Collection> getCollection({required String databaseId, required String collectionId}) async {
        final String apiPath = '/documentsdb/{databaseId}/collections/{collectionId}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
if (transactionId != null) 'transactionId': transactionId,
  ...
  /// List indexes in the collection.
    Future<models.IndexList> listIndexes({required String databaseId, required String collectionId, List<String>? queries, bool? total}) async {
        final String apiPath = '/documentsdb/{databaseId}/collections/{collectionId}/indexes'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
if (total != null) 'total': total,
  ...
  /// Attributes can be `key`, `fulltext`, and `unique`.
    Future<models.Index> createIndex({required String databaseId, required String collectionId, required String key, required enums.DocumentsDBIndexType type, required List<String> attributes, List<enums.OrderBy>? orders, List<int>? lengths}) async {
        final String apiPath = '/documentsdb/{databaseId}/collections/{collectionId}/indexes'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
if (lengths != null) 'lengths': lengths,
  ...
  /// Get index by ID.
    Future<models.Index> getIndex({required String databaseId, required String collectionId, required String key}) async {
        final String apiPath = '/documentsdb/{databaseId}/collections/{collectionId}/indexes/{key}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{key}', key);

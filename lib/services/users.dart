...
'accept': 'application/json',
  ...
  /// 
    Future<models.User> updateImpersonator({required String userId, required bool impersonator}) async {
        final String apiPath = '/users/{userId}/impersonator'.replaceAll('{userId}', userId);
...
'accept': 'application/json',
  ...
  /// through your own channel.
    Future<models.MfaChallengeSecret> getMFAChallenge({required String userId, required String challengeId}) async {
        final String apiPath = '/users/{userId}/mfa/challenges/{challengeId}'.replaceAll('{userId}', userId).replaceAll('{challengeId}', challengeId);

...
class Users extends Service {
  ...
  /// filter your results.
  Future<models.UserList<T>> list<T>({
    List<String>? queries,
    String? search,
  ...
  Future deleteIdentity({required String identityId}) async {
    final String apiPath = '/users/identities/{identityId}'.replaceAll(
      '{identityId}',
      identityId,
    );
  ...
  Future<models.User> updateEmail({
    ...
    final String apiPath = '/users/{userId}/email'.replaceAll(
      '{userId}',
      userId,
    );

    final Map<String, dynamic> apiParams = {'email': email};
  ...
  Future<models.Jwt> createJWT({
    ...
    final String apiPath = '/users/{userId}/jwts'.replaceAll(
      '{userId}',
      userId,
    );
  ...
  Future<models.User> updateLabels({
    ...
    final String apiPath = '/users/{userId}/labels'.replaceAll(
      '{userId}',
      userId,
    );

    final Map<String, dynamic> apiParams = {'labels': labels};
  ...
  Future<models.LogList<T>> listLogs<T>({
    ...
    final String apiPath = '/users/{userId}/logs'.replaceAll(
      '{userId}',
      userId,
    );
  ...
  Future<models.MembershipList<T>> listMemberships<T>({
    required String userId,
    List<String>? queries,
    String? search,
    T Function(Map<String, dynamic>)? fromJson,
  ...
  Future<models.User> updateName({
    ...
    final String apiPath = '/users/{userId}/name'.replaceAll(
      '{userId}',
      userId,
    );
  ...
  Future<models.User> updatePassword({
    ...
    final String apiPath = '/users/{userId}/password'.replaceAll(
      '{userId}',
      userId,
    );

    final Map<String, dynamic> apiParams = {'password': password};
  ...
  Future<models.User> updatePhone({
    ...
    final String apiPath = '/users/{userId}/phone'.replaceAll(
      '{userId}',
      userId,
    );

    final Map<String, dynamic> apiParams = {'number': number};
  ...
  Future<models.Preferences> getPrefs({required String userId}) async {
    final String apiPath = '/users/{userId}/prefs'.replaceAll(
      '{userId}',
      userId,
    );
  ...
  Future<models.SessionList<T>> listSessions<T>({
    ...
    final String apiPath = '/users/{userId}/sessions'.replaceAll(
      '{userId}',
      userId,
    );
  ...
  Future<models.User> updateStatus({
    ...
    final String apiPath = '/users/{userId}/status'.replaceAll(
      '{userId}',
      userId,
    );

    final Map<String, dynamic> apiParams = {'status': status};
  ...
  Future<models.TargetList<T>> listTargets<T>({
    required String userId,
    List<String>? queries,
    T Function(Map<String, dynamic>)? fromJson,
  }) async {
    final String apiPath = '/users/{userId}/targets'.replaceAll(
      '{userId}',
      userId,
    );
  ...
  Future<models.Token> createToken({
    ...
    final String apiPath = '/users/{userId}/tokens'.replaceAll(
      '{userId}',
      userId,
    );

    final Map<String, dynamic> apiParams = {'length': length, 'expire': expire};
  ...
  Future<models.User> updateEmailVerification({
    ...
    final String apiPath = '/users/{userId}/verification'.replaceAll(
      '{userId}',
      userId,
    );
  ...
  Future<models.User> updatePhoneVerification({
    ...
    final String apiPath = '/users/{userId}/verification/phone'.replaceAll(
      '{userId}',
      userId,
    );

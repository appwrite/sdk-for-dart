...
if (enabled != null) 'enabled': enabled,
    ...
    Future<models.EmbeddingList> createTextEmbeddings({required List<String> texts, enums.Model? model}) async {
...
if (rollback != null) 'rollback': rollback,
    ...
    Future<models.Database> get({required String databaseId}) async {
        final String apiPath = '/vectorsdb/{databaseId}'.replaceAll('{databaseId}', databaseId);
...
if (enabled != null) 'enabled': enabled,
    ...
    Future<models.VectorsdbCollectionList> listCollections({required String databaseId, List<String>? queries, String? search, bool? total}) async {
        final String apiPath = '/vectorsdb/{databaseId}/collections'.replaceAll('{databaseId}', databaseId);
...
if (total != null) 'total': total,
    ...
    Future<models.VectorsdbCollection> createCollection({required String databaseId, required String collectionId, required String name, required int dimension, List<String>? permissions, bool? documentSecurity, bool? enabled}) async {
        final String apiPath = '/vectorsdb/{databaseId}/collections'.replaceAll('{databaseId}', databaseId);
...
if (enabled != null) 'enabled': enabled,
    ...
    Future<models.VectorsdbCollection> getCollection({required String databaseId, required String collectionId}) async {
        final String apiPath = '/vectorsdb/{databaseId}/collections/{collectionId}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
    ...
    Future<models.VectorsdbCollection> updateCollection({required String databaseId, required String collectionId, required String name, int? dimension, List<String>? permissions, bool? documentSecurity, bool? enabled}) async {
        final String apiPath = '/vectorsdb/{databaseId}/collections/{collectionId}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
if (transactionId != null) 'transactionId': transactionId,
    ...
    Future<models.IndexList> listIndexes({required String databaseId, required String collectionId, List<String>? queries, bool? total}) async {
        final String apiPath = '/vectorsdb/{databaseId}/collections/{collectionId}/indexes'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
if (total != null) 'total': total,
    ...
    Future<models.Index> createIndex({required String databaseId, required String collectionId, required String key, required enums.VectorsDBIndexType type, required List<String> attributes, List<enums.OrderBy>? orders, List<int>? lengths}) async {
        final String apiPath = '/vectorsdb/{databaseId}/collections/{collectionId}/indexes'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
...
if (lengths != null) 'lengths': lengths,
    ...
    Future<models.Index> getIndex({required String databaseId, required String collectionId, required String key}) async {
        final String apiPath = '/vectorsdb/{databaseId}/collections/{collectionId}/indexes/{key}'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{key}', key);

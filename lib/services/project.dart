...
if (total != null) 'total': total,
  ...
  /// Update the OAuth2 server (OIDC provider) configuration.
    Future<models.Project> updateOAuth2Server({required bool enabled, required String authorizationUrl, List<String>? scopes, List<String>? authorizationDetailsTypes, int? accessTokenDuration, int? refreshTokenDuration, int? publicAccessTokenDuration, int? publicRefreshTokenDuration, int? installationAccessTokenDuration, bool? confidentialPkce, String? verificationUrl, int? userCodeLength, String? userCodeFormat, int? deviceCodeDuration, List<String>? defaultScopes, List<String>? installationScopes}) async {
...
'accept': 'application/json',
  ...
  /// your own channel. Recovery codes always remain available as a fallback.
    Future<models.Project> updateMFAFactorsPolicy({bool? totp, bool? email, bool? phone, bool? custom}) async {

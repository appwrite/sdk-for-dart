...
class Project extends Service {
  ...
  Future<models.Project> updateProtocolStatus(
      {required enums.ProtocolId protocolId, required bool enabled}) async {
    final String apiPath = '/project/protocols/{protocolId}/status'
  ...
  Future<models.Project> updateServiceStatus(
      {required enums.ServiceId serviceId, required bool enabled}) async {
    final String apiPath = '/project/services/{serviceId}/status'

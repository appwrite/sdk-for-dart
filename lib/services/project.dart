...
class Project extends Service {
  ...
  /// disable a method in your project. 
    Future<models.Project> updateAuthMethod({required enums.ProjectAuthMethodId methodId, required bool enabled}) async {
        final String apiPath = '/project/auth-methods/{methodId}'.replaceAll('{methodId}', methodId.value);
...
if (total != null) 'total': total,
  ...
  /// instead.
    Future<models.Key> createKey({required String keyId, required String name, required List<enums.ProjectKeyScopes> scopes, String? expire}) async {
        final String apiPath = '/project/keys';
...
'accept': 'application/json',
  ...
  /// instead.
    Future<models.EphemeralKey> createEphemeralKey({required List<enums.ProjectKeyScopes> scopes, required int duration}) async {
...
'accept': 'application/json',
  ...
  /// scopes, or expiration time of an API key.
    Future<models.Key> updateKey({required String keyId, required String name, required List<enums.ProjectKeyScopes> scopes, String? expire}) async {
        final String apiPath = '/project/keys/{keyId}'.replaceAll('{keyId}', keyId);
...
'accept': 'application/json',
  ...
  /// array of all mock phones and their OTPs.
    Future<models.MockNumberList> listMockPhones({List<String>? queries, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// mock phone number and its sign-in OTP for your testers.
    Future<models.MockNumber> createMockPhone({required String number, required String otp}) async {
        final String apiPath = '/project/mock-phones';
...
'accept': 'application/json',
  ...
  /// phone's OTP.
    Future<models.MockNumber> getMockPhone({required String number}) async {
        final String apiPath = '/project/mock-phones/{number}'.replaceAll('{number}', number);
  ...
  /// mock phone's OTP.
    Future<models.MockNumber> updateMockPhone({required String number, required String otp}) async {
        final String apiPath = '/project/mock-phones/{number}'.replaceAll('{number}', number);
...
'accept': 'application/json',
  ...
  /// always returned empty.
    Future<models.OAuth2ProviderList> listOAuth2Providers({List<String>? queries, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// Update the OAuth2 server (OIDC provider) configuration.
    Future<models.Project> updateOAuth2Server({required bool enabled, required String authorizationUrl, List<String>? scopes, List<String>? authorizationDetailsTypes, int? accessTokenDuration, int? refreshTokenDuration, int? publicAccessTokenDuration, int? publicRefreshTokenDuration, int? installationAccessTokenDuration, bool? confidentialPkce, String? verificationUrl, int? userCodeLength, String? userCodeFormat, int? deviceCodeDuration, List<String>? defaultScopes}) async {
...
if (authorizationDetailsTypes != null) 'authorizationDetailsTypes': authorizationDetailsTypes,
if (accessTokenDuration != null) 'accessTokenDuration': accessTokenDuration,
if (refreshTokenDuration != null) 'refreshTokenDuration': refreshTokenDuration,
if (publicAccessTokenDuration != null) 'publicAccessTokenDuration': publicAccessTokenDuration,
if (publicRefreshTokenDuration != null) 'publicRefreshTokenDuration': publicRefreshTokenDuration,
if (installationAccessTokenDuration != null) 'installationAccessTokenDuration': installationAccessTokenDuration,
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Amazon configuration.
    Future<models.OAuth2Amazon> updateOAuth2Amazon({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Apple configuration.
    Future<models.OAuth2Apple> updateOAuth2Apple({String? serviceId, String? keyId, String? teamId, String? p8File, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Appwrite configuration.
    Future<models.OAuth2Appwrite> updateOAuth2Appwrite({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Auth0 configuration.
    Future<models.OAuth2Auth0> updateOAuth2Auth0({String? clientId, String? clientSecret, String? endpoint, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Authentik configuration.
    Future<models.OAuth2Authentik> updateOAuth2Authentik({String? clientId, String? clientSecret, String? endpoint, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Autodesk configuration.
    Future<models.OAuth2Autodesk> updateOAuth2Autodesk({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Bitbucket configuration.
    Future<models.OAuth2Bitbucket> updateOAuth2Bitbucket({String? key, String? secret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Bitly configuration.
    Future<models.OAuth2Bitly> updateOAuth2Bitly({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Box configuration.
    Future<models.OAuth2Box> updateOAuth2Box({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Dailymotion configuration.
    Future<models.OAuth2Dailymotion> updateOAuth2Dailymotion({String? apiKey, String? apiSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Discord configuration.
    Future<models.OAuth2Discord> updateOAuth2Discord({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Disqus configuration.
    Future<models.OAuth2Disqus> updateOAuth2Disqus({String? publicKey, String? secretKey, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Dropbox configuration.
    Future<models.OAuth2Dropbox> updateOAuth2Dropbox({String? appKey, String? appSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Etsy configuration.
    Future<models.OAuth2Etsy> updateOAuth2Etsy({String? keyString, String? sharedSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Facebook configuration.
    Future<models.OAuth2Facebook> updateOAuth2Facebook({String? appId, String? appSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Figma configuration.
    Future<models.OAuth2Figma> updateOAuth2Figma({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 FusionAuth configuration.
    Future<models.OAuth2FusionAuth> updateOAuth2FusionAuth({String? clientId, String? clientSecret, String? endpoint, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 GitHub configuration.
    Future<models.OAuth2Github> updateOAuth2GitHub({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Gitlab configuration.
    Future<models.OAuth2Gitlab> updateOAuth2Gitlab({String? applicationId, String? secret, String? endpoint, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Google configuration.
    Future<models.OAuth2Google> updateOAuth2Google({String? clientId, String? clientSecret, List<enums.ProjectOAuth2GooglePrompt>? prompt, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Keycloak configuration.
    Future<models.OAuth2Keycloak> updateOAuth2Keycloak({String? clientId, String? clientSecret, String? endpoint, String? realmName, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Kick configuration.
    Future<models.OAuth2Kick> updateOAuth2Kick({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Linkedin configuration.
    Future<models.OAuth2Linkedin> updateOAuth2Linkedin({String? clientId, String? primaryClientSecret, bool? enabled}) async {
        final String apiPath = '/project/oauth2/linkedin';

    final Map<String, dynamic> apiParams = {
      
      if (clientId != null) 'clientId': clientId,
if (primaryClientSecret != null) 'primaryClientSecret': primaryClientSecret,
if (enabled != null) 'enabled': enabled,
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Microsoft configuration.
    Future<models.OAuth2Microsoft> updateOAuth2Microsoft({String? applicationId, String? applicationSecret, String? tenant, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Notion configuration.
    Future<models.OAuth2Notion> updateOAuth2Notion({String? oauthClientId, String? oauthClientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Oidc configuration.
    Future<models.OAuth2Oidc> updateOAuth2Oidc({String? clientId, String? clientSecret, String? wellKnownURL, String? authorizationURL, String? tokenURL, String? userInfoURL, List<enums.ProjectOAuth2OidcPrompt>? prompt, int? maxAge, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Okta configuration.
    Future<models.OAuth2Okta> updateOAuth2Okta({String? clientId, String? clientSecret, String? domain, String? authorizationServerId, bool? enabled}) async {
...
if (authorizationServerId != null) 'authorizationServerId': authorizationServerId,
if (enabled != null) 'enabled': enabled,
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Paypal configuration.
    Future<models.OAuth2Paypal> updateOAuth2Paypal({String? clientId, String? secretKey, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 PaypalSandbox configuration.
    Future<models.OAuth2Paypal> updateOAuth2PaypalSandbox({String? clientId, String? secretKey, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Podio configuration.
    Future<models.OAuth2Podio> updateOAuth2Podio({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Salesforce configuration.
    Future<models.OAuth2Salesforce> updateOAuth2Salesforce({String? customerKey, String? customerSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Slack configuration.
    Future<models.OAuth2Slack> updateOAuth2Slack({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Spotify configuration.
    Future<models.OAuth2Spotify> updateOAuth2Spotify({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Stripe configuration.
    Future<models.OAuth2Stripe> updateOAuth2Stripe({String? clientId, String? apiSecretKey, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Tradeshift configuration.
    Future<models.OAuth2Tradeshift> updateOAuth2Tradeshift({String? oauth2ClientId, String? oauth2ClientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Tradeshift Sandbox configuration.
    Future<models.OAuth2Tradeshift> updateOAuth2TradeshiftSandbox({String? oauth2ClientId, String? oauth2ClientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Twitch configuration.
    Future<models.OAuth2Twitch> updateOAuth2Twitch({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 WordPress configuration.
    Future<models.OAuth2WordPress> updateOAuth2WordPress({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 X configuration.
    Future<models.OAuth2X> updateOAuth2X({String? customerKey, String? secretKey, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Yahoo configuration.
    Future<models.OAuth2Yahoo> updateOAuth2Yahoo({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Yandex configuration.
    Future<models.OAuth2Yandex> updateOAuth2Yandex({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Zoho configuration.
    Future<models.OAuth2Zoho> updateOAuth2Zoho({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the project OAuth2 Zoom configuration.
    Future<models.OAuth2Zoom> updateOAuth2Zoom({String? clientId, String? clientSecret, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// secret, p8 file, key/team IDs) are write-only and always returned empty.
    Future<models.Model> getOAuth2Provider({required enums.ProjectOAuthProviderId providerId}) async {
        final String apiPath = '/project/oauth2/{providerId}'.replaceAll('{providerId}', providerId.value);
...
'accept': 'application/json',
  ...
  /// Get a list of all project policies and their current configuration.
    Future<models.PolicyList> listPolicies({List<String>? queries, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// are denied during new users sign-ups and email updates.
    Future<models.Project> updateDenyAliasedEmailPolicy({required bool enabled}) async {
...
'accept': 'application/json',
  ...
  /// domains) are allowed during new user sign-ups and email updates.
    Future<models.Project> updateDenyCorporateEmailPolicy({required bool enabled}) async {
...
'accept': 'application/json',
  ...
  /// during new users sign-ups and email updates.
    Future<models.Project> updateDenyDisposableEmailPolicy({required bool enabled}) async {
...
'accept': 'application/json',
  ...
  /// during new users sign-ups and email updates.
    Future<models.Project> updateDenyFreeEmailPolicy({required bool enabled}) async {
...
'accept': 'application/json',
  ...
  /// email, phone number, and MFA status of other members..
    Future<models.Project> updateMembershipPrivacyPolicy({bool? userId, bool? userEmail, bool? userPhone, bool? userName, bool? userMFA, bool? userAccessedAt}) async {
...
if (userAccessedAt != null) 'userAccessedAt': userAccessedAt,
...
'accept': 'application/json',
  ...
  /// their password, password must not be contained in the dictionary.
    Future<models.Project> updatePasswordDictionaryPolicy({required bool enabled}) async {
...
'accept': 'application/json',
  ...
  /// changes since the policy is enabled.
    Future<models.Project> updatePasswordHistoryPolicy({required int? total}) async {
...
'accept': 'application/json',
  ...
  /// number.
    Future<models.Project> updatePasswordPersonalDataPolicy({required bool enabled}) async {
...
'accept': 'application/json',
  ...
  /// Update the password strength requirements for users in the project.
    Future<models.PolicyPasswordStrength> updatePasswordStrengthPolicy({int? min, bool? uppercase, bool? lowercase, bool? number, bool? symbols}) async {
...
'accept': 'application/json',
  ...
  /// is enabled.
    Future<models.Project> updateSessionAlertPolicy({required bool enabled}) async {
...
'accept': 'application/json',
  ...
  /// stay active for.
    Future<models.Project> updateSessionDurationPolicy({required int duration}) async {
...
'accept': 'application/json',
  ...
  /// changes their password, they will be logged out of all their devices.
    Future<models.Project> updateSessionInvalidationPolicy({required bool enabled}) async {
...
'accept': 'application/json',
  ...
  /// configuration for the requested project policy.
    Future<models.Model> getPolicy({required enums.ProjectPolicyId policyId}) async {
        final String apiPath = '/project/policies/{policyId}'.replaceAll('{policyId}', policyId.value);
  ...
  /// disable a protocol in your project. 
    Future<models.Project> updateProtocol({required enums.ProjectProtocolId protocolId, required bool enabled}) async {
        final String apiPath = '/project/protocols/{protocolId}'.replaceAll('{protocolId}', protocolId.value);
...
'accept': 'application/json',
  ...
  /// disable a service in your project. 
    Future<models.Project> updateService({required enums.ProjectServiceId serviceId, required bool enabled}) async {
        final String apiPath = '/project/services/{serviceId}'.replaceAll('{serviceId}', serviceId.value);
...
'accept': 'application/json',
  ...
  /// sending transactional emails.
    Future<models.Project> updateSMTP({String? host, int? port, String? username, String? password, String? senderEmail, String? senderName, String? replyToEmail, String? replyToName, enums.ProjectSMTPSecure? secure, bool? enabled}) async {
...
'accept': 'application/json',
  ...
  /// locales.
    Future<models.EmailTemplateList> listEmailTemplates({List<String>? queries, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// endpoint to modify the content of your email templates.
    Future<models.EmailTemplate> updateEmailTemplate({required enums.ProjectEmailTemplateId templateId, enums.ProjectEmailTemplateLocale? locale, String? subject, String? message, String? senderName, String? senderEmail, String? replyToEmail, String? replyToName}) async {
        final String apiPath = '/project/templates/email';
...
'accept': 'application/json',
  ...
  /// details.
    Future<models.EmailTemplate> getEmailTemplate({required enums.ProjectEmailTemplateId templateId, enums.ProjectEmailTemplateLocale? locale}) async {
        final String apiPath = '/project/templates/email/{templateId}'.replaceAll('{templateId}', templateId.value);

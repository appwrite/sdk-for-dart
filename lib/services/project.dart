...
class Project extends Service {
  ...
  /// disable a method in your project. 
    Future<models.Project> updateAuthMethod({required enums.AuthMethod methodId, required bool enabled}) async {
...
'expire': expire,
  ...
  /// instead.
    Future<models.EphemeralKey> createEphemeralKey({required List<enums.Scopes> scopes, required int duration}) async {
...
'enabled': enabled,
  ...
  /// Update the project OAuth2 Google configuration.
    Future<models.OAuth2Google> updateOAuth2Google({String? clientId, String? clientSecret, bool? enabled}) async {
...
'enabled': enabled,
  ...
  /// secret, p8 file, key/team IDs) are write-only and always returned empty.
    Future<models.Model> getOAuth2Provider({required enums.OAuthProvider providerId}) async {
...
if (userMFA != null) 'userMFA': userMFA,
  ...
  /// configuration for the requested project policy.
    Future<models.Model> getPolicy({required enums.ProjectPolicy policyId}) async {
  ...
  /// disable a protocol in your project. 
    Future<models.Project> updateProtocol({required enums.ProtocolId protocolId, required bool enabled}) async {
  ...
  /// disable a service in your project. 
    Future<models.Project> updateService({required enums.ServiceId serviceId, required bool enabled}) async {
  ...
  /// sending transactional emails.
    Future<models.Project> updateSMTP({String? host, int? port, String? username, String? password, String? senderEmail, String? senderName, String? replyToEmail, String? replyToName, enums.Secure? secure, bool? enabled}) async {
...
if (total != null) 'total': total,
  ...
  /// endpoint to modify the content of your email templates.
    Future<models.EmailTemplate> updateEmailTemplate({required enums.EmailTemplateType templateId, enums.EmailTemplateLocale? locale, String? subject, String? message, String? senderName, String? senderEmail, String? replyToEmail, String? replyToName}) async {
        final String apiPath = '/project/templates/email';
...
'replyToName': replyToName,
  ...
  /// details.
    Future<models.EmailTemplate> getEmailTemplate({required enums.EmailTemplateType templateId, enums.EmailTemplateLocale? locale}) async {

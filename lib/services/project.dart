...
if (total != null) 'total': total,
  ...
  /// Update the OAuth2 server (OIDC provider) configuration.
    Future<models.Project> updateOAuth2Server({required bool enabled, required String authorizationUrl, List<String>? scopes, int? accessTokenDuration, int? refreshTokenDuration, int? publicAccessTokenDuration, int? publicRefreshTokenDuration, bool? confidentialPkce}) async {
...
'enabled': enabled,
  ...
  /// Update the project OAuth2 Oidc configuration.
    Future<models.OAuth2Oidc> updateOAuth2Oidc({String? clientId, String? clientSecret, String? wellKnownURL, String? authorizationURL, String? tokenURL, String? userInfoURL, bool? enabled}) async {
...
if (total != null) 'total': total,
  ...
  /// email, phone number, and MFA status of other members..
    Future<models.Project> updateMembershipPrivacyPolicy({bool? userId, bool? userEmail, bool? userPhone, bool? userName, bool? userMFA}) async {

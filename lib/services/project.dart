...
class Project extends Service {
  ...
  /// disable a method in your project. 
    Future<models.Project> updateAuthMethod({required enums.MethodId methodId, required bool enabled}) async {
...
if (total != null) 'total': total,
  ...
  /// secret, p8 file, key/team IDs) are write-only and always returned empty.
    Future<models.Model> getOAuth2Provider({required enums.ProviderId providerId}) async {
...
if (userMFA != null) 'userMFA': userMFA,
  ...
  /// configuration for the requested project policy.
    Future<models.Model> getPolicy({required enums.PolicyId policyId}) async {

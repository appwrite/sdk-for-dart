...
if (total != null) 'total': total,
  ...
  /// Update the OAuth2 server (OIDC provider) configuration.
    Future<models.Project> updateOAuth2Server({required bool enabled, required String authorizationUrl, List<String>? scopes, List<String>? authorizationDetailsTypes, int? accessTokenDuration, int? refreshTokenDuration, int? publicAccessTokenDuration, int? publicRefreshTokenDuration, bool? confidentialPkce, String? verificationUrl, int? userCodeLength, String? userCodeFormat, int? deviceCodeDuration, List<String>? defaultScopes}) async {

...
if (metadata != null) 'metadata': metadata,
  ...
  /// 
    Future<models.Presence> update({required String presenceId, required String userId, String? status, String? expiresAt, Map? metadata, List<String>? permissions, bool? purge}) async {
        final String apiPath = '/presences/{presenceId}'.replaceAll('{presenceId}', presenceId);

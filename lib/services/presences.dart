...
if (ttl != null) 'ttl': ttl,
  ...
  /// Create or update a presence log by its unique ID.
    Future<models.Presence> upsert({required String presenceId, required String? userId, required String status, List<String>? permissions, String? expiresAt, Map? metadata}) async {
        final String apiPath = '/presences/{presenceId}'.replaceAll('{presenceId}', presenceId);
...
if (metadata != null) 'metadata': metadata,
  ...
  /// Update a presence log by its unique ID.
    Future<models.Presence> updatePresence({required String presenceId, required String? userId, String? status, String? expiresAt, Map? metadata, List<String>? permissions, bool? purge}) async {
        final String apiPath = '/presences/{presenceId}'.replaceAll('{presenceId}', presenceId);

...
class Messaging extends Service {
  ...
  @Deprecated(
    'This API has been deprecated since 1.8.0. Please use `CreateSMS` instead.',
  )
  ...
  ///
  @Deprecated(
    'This API has been deprecated since 1.8.0. Please use `UpdateSMS` instead.',
  )
  ...
  Future<models.LogList> listMessageLogs({
    required String messageId,
    List<String>? queries,
  }) async {
    final String apiPath = '/messaging/messages/{messageId}/logs'.replaceAll(
      '{messageId}',
      messageId,
    );
  ...
  @Deprecated(
    'This API has been deprecated since 1.8.0. Please use `CreateAPNSProvider` instead.',
  )
  ...
  @Deprecated(
    'This API has been deprecated since 1.8.0. Please use `UpdateAPNSProvider` instead.',
  )
  ...
  @Deprecated(
    'This API has been deprecated since 1.8.0. Please use `CreateFCMProvider` instead.',
  )
  ...
  @Deprecated(
    'This API has been deprecated since 1.8.0. Please use `UpdateFCMProvider` instead.',
  )
  ...
  @Deprecated(
    'This API has been deprecated since 1.8.0. Please use `CreateSMTPProvider` instead.',
  )
  ...
  @Deprecated(
    'This API has been deprecated since 1.8.0. Please use `UpdateSMTPProvider` instead.',
  )
  ...
  Future<models.LogList> listProviderLogs({
    required String providerId,
    List<String>? queries,
  }) async {
    final String apiPath = '/messaging/providers/{providerId}/logs'.replaceAll(
      '{providerId}',
      providerId,
    );
  ...
  Future<models.LogList> listSubscriberLogs({
    required String subscriberId,
    List<String>? queries,
  }) async {
    final String apiPath = '/messaging/subscribers/{subscriberId}/logs'
  ...
  Future<models.LogList> listTopicLogs({
    required String topicId,
    List<String>? queries,
  }) async {
    final String apiPath = '/messaging/topics/{topicId}/logs'.replaceAll(
      '{topicId}',
      topicId,
    );

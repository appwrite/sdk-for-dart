...
class Messaging extends Service {
  ...
  Future<models.MessageList<T>> listMessages<T>({
    List<String>? queries,
    String? search,
  ...
  Future<models.LogList<T>> listMessageLogs<T>({
    required String messageId,
    List<String>? queries,
    T Function(Map<String, dynamic>)? fromJson,
  }) async {
  ...
  Future<models.ProviderList<T>> listProviders<T>({
    List<String>? queries,
    String? search,
    T Function(Map<String, dynamic>)? fromJson,
  }) async {
  ...
  Future<models.LogList<T>> listProviderLogs<T>({
    required String providerId,
    List<String>? queries,
    T Function(Map<String, dynamic>)? fromJson,
  }) async {
  ...
  Future<models.LogList<T>> listSubscriberLogs<T>({
  ...
  Future<models.TopicList<T>> listTopics<T>({
    List<String>? queries,
    String? search,
    T Function(Map<String, dynamic>)? fromJson,
  }) async {
  ...
  Future<models.LogList<T>> listTopicLogs<T>({
    required String topicId,
    List<String>? queries,
    T Function(Map<String, dynamic>)? fromJson,
  }) async {
  ...
  Future<models.SubscriberList<T>> listSubscribers<T>({
    required String topicId,
    List<String>? queries,
    String? search,
    T Function(Map<String, dynamic>)? fromJson,

...
class Teams extends Service {
    ...
    Future<Response> list({String search = null, int limit = 25, int offset = null, OrderType orderType = OrderType.asc}) async {
       String path = '/teams';
       ...
       Map<String, dynamic> params = {
         ...
         'limit': limit,
         'offset': offset,
         'orderType': orderType.toString().toUpperCase(),
       };
     ...
     /// project.
    Future<Response> create({@required String name, List<String> roles = const ["owner"]}) async {
       String path = '/teams';
    ...
    Future<Response> createMembership({@required String teamId, @required String email, @required List<String> roles,
      @required String url, String name = null}) async {
       String path = '/teams/{teamId}/memberships'.replaceAll(RegExp('{teamId}'), teamId);
    ...
    Future<Response> deleteMembership({@required String teamId, @required String inviteId}) async {
     ...
     /// was sent.
    Future<Response> updateMembershipStatus({@required String teamId, @required String inviteId,

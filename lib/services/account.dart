...
class Account extends Service {
    ...
    Future<Response> updatePrefs({@required Map<String, dynamic> prefs}) async {
       String path = '/account/prefs';
    ...
    Future<Response> updateRecovery({@required String userId, @required String secret,
      @required String passwordA, @required String passwordB}) async {
       String path = '/account/recovery';

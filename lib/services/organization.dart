...
'accept': 'application/json',
  ...
  /// Get a list of all memberships from the current organization.
    Future<models.MembershipList> listMemberships({List<String>? queries, String? search, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// member doesn't exist in the project it will be automatically created.
    Future<models.Membership> createMembership({required List<String> roles, String? email, String? userId, String? phone, String? url, String? name}) async {
        final String apiPath = '/organization/memberships';
...
'accept': 'application/json',
  ...
  /// Get a membership from the current organization by its unique ID.
    Future<models.Membership> getMembership({required String membershipId}) async {
        final String apiPath = '/organization/memberships/{membershipId}'.replaceAll('{membershipId}', membershipId);
  ...
  /// Modify the roles of a member in the current organization.
    Future<models.Membership> updateMembership({required String membershipId, required List<String> roles}) async {
        final String apiPath = '/organization/memberships/{membershipId}'.replaceAll('{membershipId}', membershipId);

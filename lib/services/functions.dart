...
class Functions extends Service {
  ...
  /// filter your results.
  Future<models.FunctionList<T>> list<T>({
    List<String>? queries,
    String? search,
  ...
  Future<models.RuntimeList<T>> listRuntimes<T>({
    T Function(Map<String, dynamic>)? fromJson,
  }) async {
  ...
  Future<models.Func> updateFunctionDeployment({
    ...
    final String apiPath = '/functions/{functionId}/deployment'.replaceAll(
      '{functionId}',
      functionId,
    );
  ...
  Future<models.DeploymentList<T>> listDeployments<T>({
    ...
    final String apiPath = '/functions/{functionId}/deployments'.replaceAll(
      '{functionId}',
      functionId,
    );
  ...
  Future<models.Deployment> createVcsDeployment({
    ...
    final String apiPath = '/functions/{functionId}/deployments/vcs'.replaceAll(
      '{functionId}',
      functionId,
    );
  ...
  Future<models.ExecutionList<T>> listExecutions<T>({
    required String functionId,
    List<String>? queries,
    T Function(Map<String, dynamic>)? fromJson,
  }) async {
  ...
  Future<models.VariableList<T>> listVariables<T>({
    ...
    final String apiPath = '/functions/{functionId}/variables'.replaceAll(
      '{functionId}',
      functionId,
    );

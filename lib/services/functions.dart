...
class Functions extends Service {
  ...
  /// filter your results.
    Future<models.FunctionList> list({List<String>? queries, String? search, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// API.
    Future<models.Func> create({required String functionId, required String name, required enums.Runtime runtime, List<String>? execute, List<String>? events, String? schedule, int? timeout, bool? enabled, bool? logging, String? entrypoint, String? commands, List<enums.ProjectKeyScopes>? scopes, String? installationId, String? providerRepositoryId, String? providerBranch, bool? providerSilentMode, String? providerRootDirectory, List<String>? providerBranches, List<String>? providerPaths, String? buildSpecification, String? runtimeSpecification, int? deploymentRetention}) async {
        final String apiPath = '/functions';
...
'accept': 'application/json',
  ...
  /// params to filter your results.
    Future<models.DeploymentList> listDeployments({required String functionId, List<String>? queries, String? search, bool? total}) async {
...
'accept': 'application/json',
  ...
  /// find the template details.
    Future<models.Deployment> createTemplateDeployment({required String functionId, required String repository, required String owner, required String rootDirectory, required enums.TemplateReferenceType type, required String reference, bool? activate}) async {
...
'accept': 'application/json',
  ...
  /// This endpoint lets you create deployment from a branch, commit, or a tag.
    Future<models.Deployment> createVcsDeployment({required String functionId, required enums.VCSReferenceType type, required String reference, bool? activate}) async {
...
'accept': 'application/json',
  ...
  /// browser to start downloading the file to user downloads directory.
    Future<Uint8List> getDeploymentDownload({required String functionId, required String deploymentId, enums.DeploymentDownloadType? type, String? token}) async {
...
'accept': 'application/json',
  ...
  /// Get a list of all variables of a specific function.
    Future<models.VariableList> listVariables({required String functionId, List<String>? queries, bool? total}) async {
...
if (total != null) 'total': total,
  ...
  /// in the function at runtime as environment variables.
    Future<models.Variable> createVariable({required String functionId, required String variableId, required String key, required String value, bool? secret}) async {
        final String apiPath = '/functions/{functionId}/variables'.replaceAll('{functionId}', functionId);
...
'accept': 'application/json',
  ...
  /// Update variable by its unique ID.
    Future<models.Variable> updateVariable({required String functionId, required String variableId, String? key, String? value, bool? secret}) async {
        final String apiPath = '/functions/{functionId}/variables/{variableId}'.replaceAll('{functionId}', functionId).replaceAll('{variableId}', variableId);
